    ...
    <div class="form">
      ...
      <el-form ref="form" :model="form" :rules="rules">
        <el-form-item prop="name">
          <el-input v-model="form.name" placeholder="admin" @keypress.enter.native="login">
            <i slot="prepend" class="el-icon-s-custom" />
          </el-input>
        </el-form-item>
        <el-form-item prop="pwd">
          <el-input v-model="form.pwd" type="password" placeholder="000000" @keypress.enter.native="login">
            <i slot="prepend" class="el-icon-lock" />
          </el-input>
        </el-form-item>
      </el-form>
      <DragVerification :is-verify.sync="isVerify" @success="verifySuccess" />
