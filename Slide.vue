<template>
    <div class="drag_verify" :style="dragVerifyStyle" @mousemove="dragMoving" @mouseup="dragFinish" @mouseleave="dragFinish" @touchmove="dragMoving" @touchend="dragFinish">
			...
			<div class="dv_handler dv_handler_bg" @mousedown="dragStart"  ref="handler" :style="handlerStyle" @touchstart="dragStart" id="zzr">
	...
	methods:{
      ...
      if(this.isMoving && !this.isPassing){
        ...
        var _x = (e.pageX || e.changedTouches[0].pageX)- this.x;
				if(_x <this.width || _x >this.width + this.height ){
